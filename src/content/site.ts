...
export const faqItems = [
  ...
  {
    question: '现在可以下载吗？',
    answer: '可以。官网现已提供 BinBot Todo v3.0.3，当前安装包适用于 Apple Silicon（arm64）Mac。',
  },
  {
    question: '首次打开为什么会出现安全提示？',
    answer: '当前 v3.0.3 安装包已完成 ad-hoc 应用包签名，但未使用 Apple Developer ID 且未经公证。首次打开时如出现安全提示，可在系统设置的“隐私与安全性”中选择“仍要打开”。',
  },
  {
    question: '数据会上传到云端吗？',
